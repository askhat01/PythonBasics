...
initial_list = [randint(0,1000) for _ in range(0, randint(2, 20))]
last_list = [num for i, num in enumerate(initial_list[1:]) if num > initial_list[i]]
...
print(f"Initial list\n{my_list}\List with uniq elements\n{uniq_list}")
...
uniq_list = [a for a in range(100, 1001, 2)]
print(f"List\n{uniq_list}\Multiplication of numbers\n{reduce(my_list, uniq_list)}")
